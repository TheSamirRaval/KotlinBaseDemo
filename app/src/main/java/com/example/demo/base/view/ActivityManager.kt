...
import com.example.demo.common.helper.Debug
...
class ActivityManager {
    ...
    fun init(application: Application) {
        ...
        this.application?.registerActivityLifecycleCallbacks(object : Application.ActivityLifecycleCallbacks {
            ...
            override fun onActivityStarted(activity: Activity) {foregroundActivity = activity}
        ...
        }) ?: Debug.e("ActivityManager","Application object must not be null.")
    }
}
